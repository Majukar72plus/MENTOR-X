...
const generateRecommendations = (testResults) => {
  ...
  if (aptitudeScore > 15 && technicalScore > 14) {
  ...
  } else if (interestScore > 14 && personalityScore > 12) {
  ...
  } else if (personalityScore > 12 && aptitudeScore > 10) {
  ...
  return { message, careerOptions, courses };
};
